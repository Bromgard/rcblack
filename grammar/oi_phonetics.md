...
The following pronunciation system is an attempt to capture what Old Icelandic may have sounded like in the thirteenth and fourteenth centuries when the _Íslendingasögur_, the Family Sagas, were committed to parchment. Such pronunciation systems are synthetic artifacts that erase the natural diversity and evolution of a living language. Since Old Icelandic is no longer spoken, this system is speculation and reconstruction. These are approximate sound qualities, not exact, and some sounds, such as the liquids (l,r), are always very difficult to reconstruct. When using the pronunciation system of any historical language, consistency is more important than correctness. 
